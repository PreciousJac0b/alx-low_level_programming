### ALX C PROGRAMMING PROJECT FILE I/O


In this project, I learned about the three standard file descriptors and their `POSIX` names, as well as the difference between functions and system calls. I
